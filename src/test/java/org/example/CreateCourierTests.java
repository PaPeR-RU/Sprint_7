...
public class CreateCourierTests extends CourierAPIHandler {
    ...
    @Description("Тест проверки API на создание нового курьера. ОР - курьер создан")
    ...
    @Description("Тест проверки возможности создавать двух одинаковых курьеров. ОР - одинаковых курьеров создать нельзя")
    ...
    @Description("Тест проверки API на создание нового курьера без входных данных. ОР - новый курьер НЕ создан")
    ...
    @Description("Тест проверки API на создание нового курьера без логина. ОР - новый курьер НЕ создан")
    ...
    @Description("Тест проверки API на создание нового курьера без пароля. ОР - новый курьер НЕ создан")
