...
public class LoginCourierTests extends CourierAPIHandler {
    ...
    @Description("Тест проверки API логина курьера. ОР - курьер авторизован в системе, возвращается его id")
    ...
    @Description("Тест проверки API логина курьера без входных данных. ОР - курьер НЕ авторизован в системе")
    ...
    @Description("Тест проверки API логина курьера без логина. ОР - курьер НЕ авторизован в системе")
    ...
    @Description("Тест проверки API логина курьера без пароля. ОР - курьер НЕ авторизован в системе")
    ...
    @Description("Тест проверки API логина курьера с некорректным логином. ОР - курьер НЕ авторизован в системе")
    ...
    @Description("Тест проверки API логина курьера с некорректным паролем. ОР - курьер НЕ авторизован в системе")
